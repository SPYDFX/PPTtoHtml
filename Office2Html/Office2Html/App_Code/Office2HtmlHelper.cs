...
namespace Wolfy.OfficePreview
{
    public class Office2HtmlHelper
    {
        ...
        public static void PPT2Html(string path, string savePath, string wordFileName)
        {
            ...
            prsPres.SaveAs(strDestinationFile, Microsoft.Office.Interop.PowerPoint.PpSaveAsFileType.ppSaveAsJPG, MsoTriState.msoTrue);
            prsPres.Close();
            ppApp.Quit();
        ...
        public static void writeHtml(string path)
        {
            ...
            FileStream fs = new FileStream(dir.FullName + "\\path.html", FileMode.Create, FileAccess.Write);//创建HTML文件
